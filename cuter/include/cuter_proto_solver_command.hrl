...
-ifndef(cuter_proto_solver_command).
-define(cuter_proto_solver_command, true).

-define(cuter_proto_solver_command_gpb_version, "3.26.4").

-ifndef('SOLVERCOMMAND_PB_H').
-define('SOLVERCOMMAND_PB_H', true).
-record('SolverCommand',
        {type,                          % = 1, {enum,'SolverCommand.Type'} (optional)
         filename,                      % = 2, string (optional)
         to_constraint,                 % = 3, int64 (optional)
         symbvar,                       % = 4, {msg,'ErlangTerm'} (optional)
         symbvar_value                  % = 5, {msg,'ErlangTerm'} (optional)
        }).
-endif.
