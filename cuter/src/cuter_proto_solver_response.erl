...
-module(cuter_proto_solver_response).
...
-export(['enum_symbol_by_value_SolverResponse.Type'/1, 'enum_value_by_symbol_SolverResponse.Type'/1]).
-export(['enum_symbol_by_value_SolverResponse.Status'/1, 'enum_value_by_symbol_SolverResponse.Status'/1]).
...
-include("cuter_proto_solver_response.hrl").
-include("gpb.hrl").
...
encode_msg(Msg, Opts) ->
    ...
    case Msg of
      #'SolverResponse.ModelEntry'{} ->
	  'e_msg_SolverResponse.ModelEntry'(Msg, TrUserData);
      #'SolverResponse.Model'{} ->
	  'e_msg_SolverResponse.Model'(Msg, TrUserData);
      #'SolverResponse'{} ->
	  e_msg_SolverResponse(Msg, TrUserData);
      #'ErlangTerm.MapEntry'{} ->
...
'e_msg_SolverResponse.ModelEntry'(Msg, TrUserData) ->
    'e_msg_SolverResponse.ModelEntry'(Msg, <<>>,
				      TrUserData).


'e_msg_SolverResponse.ModelEntry'(#'SolverResponse.ModelEntry'{var
								   = F1,
							       value = F2},
				  Bin, TrUserData) ->
    B1 = if F1 == undefined -> Bin;
		...
		begin
		  ...
		  if TrF1 =:= undefined -> Bin;
		     true ->
			 'e_mfield_SolverResponse.ModelEntry_var'(TrF1,
								  <<Bin/binary,
								    10>>,
								  TrUserData)
		  end
    ...
    if F2 == undefined -> B1;
	   ...
	   begin
		...
		true ->
		    'e_mfield_SolverResponse.ModelEntry_value'(TrF2,
							       <<B1/binary,
								 18>>,
							       TrUserData)
	     end
...
'e_msg_SolverResponse.Model'(#'SolverResponse.Model'{entries
							 = F1},
			     Bin, TrUserData) ->
    begin
      TrF1 = id(F1, TrUserData),
      if TrF1 == [] -> Bin;
	 true ->
	     'e_field_SolverResponse.Model_entries'(TrF1, Bin,
						    TrUserData)
      end
    end.
...
e_msg_SolverResponse(#'SolverResponse'{type = F1,
				       data = F2},
		     Bin, TrUserData) ->
    B1 = if F1 == undefined -> Bin;
	    true ->
		begin
		  TrF1 = id(F1, TrUserData),
		  if TrF1 =:= 'MODEL_STATUS' -> Bin;
		     true ->
			 'e_enum_SolverResponse.Type'(TrF1, <<Bin/binary, 8>>)
		  end
		end
	 end,
    case F2 of
	  ...
	  begin
	    ...
	    'e_enum_SolverResponse.Status'(TrOF2, <<B1/binary, 16>>)
	  end;
      {model, OF2} ->
	  begin
	    TrOF2 = id(OF2, TrUserData),
	    e_mfield_SolverResponse_model(TrOF2, <<B1/binary, 26>>,
					  TrUserData)
	  end
    end.
...
'e_mfield_SolverResponse.ModelEntry_var'(Msg, Bin,
					 TrUserData) ->
    SubBin = e_msg_ErlangTerm(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

'e_mfield_SolverResponse.ModelEntry_value'(Msg, Bin,
					   TrUserData) ->
    SubBin = e_msg_ErlangTerm(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

'e_mfield_SolverResponse.Model_entries'(Msg, Bin,
					TrUserData) ->
    SubBin = 'e_msg_SolverResponse.ModelEntry'(Msg, <<>>,
					       TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

'e_field_SolverResponse.Model_entries'([Elem | Rest],
				       Bin, TrUserData) ->
    Bin2 = <<Bin/binary, 10>>,
    Bin3 = 'e_mfield_SolverResponse.Model_entries'(id(Elem,
						      TrUserData),
						   Bin2, TrUserData),
    'e_field_SolverResponse.Model_entries'(Rest, Bin3,
					   TrUserData);
'e_field_SolverResponse.Model_entries'([], Bin,
				       _TrUserData) ->
    Bin.

e_mfield_SolverResponse_model(Msg, Bin, TrUserData) ->
    SubBin = 'e_msg_SolverResponse.Model'(Msg, <<>>,
					  TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.
...
'e_enum_SolverResponse.Type'('MODEL_STATUS', Bin) ->
    <<Bin/binary, 0>>;
'e_enum_SolverResponse.Type'('MODEL_DATA', Bin) ->
    <<Bin/binary, 1>>;
'e_enum_SolverResponse.Type'(V, Bin) ->
    e_varint(V, Bin).

'e_enum_SolverResponse.Status'('SAT', Bin) ->
    <<Bin/binary, 0>>;
'e_enum_SolverResponse.Status'('UNSAT', Bin) ->
    <<Bin/binary, 1>>;
'e_enum_SolverResponse.Status'('UNKNOWN', Bin) ->
    <<Bin/binary, 2>>;
'e_enum_SolverResponse.Status'('TIMEOUT', Bin) ->
    <<Bin/binary, 3>>;
'e_enum_SolverResponse.Status'(V, Bin) ->
    e_varint(V, Bin).
...
decode_msg(Bin, MsgName, Opts) when is_binary(Bin) ->
    ...
    case MsgName of
      'SolverResponse.ModelEntry' ->
	  'd_msg_SolverResponse.ModelEntry'(Bin, TrUserData);
      'SolverResponse.Model' ->
	  'd_msg_SolverResponse.Model'(Bin, TrUserData);
      'SolverResponse' ->
	  d_msg_SolverResponse(Bin, TrUserData);
      'ErlangTerm.MapEntry' ->
...
'd_msg_SolverResponse.ModelEntry'(Bin, TrUserData) ->
    'dfp_read_field_def_SolverResponse.ModelEntry'(Bin, 0,
						   0, id(undefined, TrUserData),
						   id(undefined, TrUserData),
						   TrUserData).

'dfp_read_field_def_SolverResponse.ModelEntry'(<<10,
						 Rest/binary>>,
					       Z1, Z2, F1, F2, TrUserData) ->
    'd_field_SolverResponse.ModelEntry_var'(Rest, Z1, Z2,
					    F1, F2, TrUserData);
'dfp_read_field_def_SolverResponse.ModelEntry'(<<18,
						 Rest/binary>>,
					       Z1, Z2, F1, F2, TrUserData) ->
    'd_field_SolverResponse.ModelEntry_value'(Rest, Z1, Z2,
					      F1, F2, TrUserData);
'dfp_read_field_def_SolverResponse.ModelEntry'(<<>>, 0,
					       0, F1, F2, _) ->
    #'SolverResponse.ModelEntry'{var = F1, value = F2};
'dfp_read_field_def_SolverResponse.ModelEntry'(Other,
					       Z1, Z2, F1, F2, TrUserData) ->
    'dg_read_field_def_SolverResponse.ModelEntry'(Other, Z1,
						  Z2, F1, F2, TrUserData).

'dg_read_field_def_SolverResponse.ModelEntry'(<<1:1,
						X:7, Rest/binary>>,
					      N, Acc, F1, F2, TrUserData)
    when N < 32 - 7 ->
    'dg_read_field_def_SolverResponse.ModelEntry'(Rest,
						  N + 7, X bsl N + Acc, F1, F2,
						  TrUserData);
'dg_read_field_def_SolverResponse.ModelEntry'(<<0:1,
						X:7, Rest/binary>>,
					      N, Acc, F1, F2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  'd_field_SolverResponse.ModelEntry_var'(Rest, 0, 0, F1,
						  F2, TrUserData);
      18 ->
	  'd_field_SolverResponse.ModelEntry_value'(Rest, 0, 0,
						    F1, F2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		'skip_varint_SolverResponse.ModelEntry'(Rest, 0, 0, F1,
							F2, TrUserData);
	    1 ->
		'skip_64_SolverResponse.ModelEntry'(Rest, 0, 0, F1, F2,
						    TrUserData);
	    2 ->
		'skip_length_delimited_SolverResponse.ModelEntry'(Rest,
								  0, 0, F1, F2,
								  TrUserData);
	    5 ->
		'skip_32_SolverResponse.ModelEntry'(Rest, 0, 0, F1, F2,
						    TrUserData)
	  end
    end;
'dg_read_field_def_SolverResponse.ModelEntry'(<<>>, 0,
					      0, F1, F2, _) ->
    #'SolverResponse.ModelEntry'{var = F1, value = F2}.

'd_field_SolverResponse.ModelEntry_var'(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F1, F2, TrUserData)
    when N < 57 ->
    'd_field_SolverResponse.ModelEntry_var'(Rest, N + 7,
					    X bsl N + Acc, F1, F2, TrUserData);
'd_field_SolverResponse.ModelEntry_var'(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F1, F2, TrUserData) ->
    Len = X bsl N + Acc,
    ...
    NewFValue = id(d_msg_ErlangTerm(Bs, TrUserData),
		   TrUserData),
    'dfp_read_field_def_SolverResponse.ModelEntry'(Rest2, 0,
						   0,
						   if F1 == undefined ->
							  NewFValue;
						      true ->
...
'd_field_SolverResponse.ModelEntry_value'(<<1:1, X:7,
					    Rest/binary>>,
					  N, Acc, F1, F2, TrUserData)
    when N < 57 ->
    'd_field_SolverResponse.ModelEntry_value'(Rest, N + 7,
					      X bsl N + Acc, F1, F2,
					      TrUserData);
'd_field_SolverResponse.ModelEntry_value'(<<0:1, X:7,
					    Rest/binary>>,
					  N, Acc, F1, F2, TrUserData) ->
    Len = X bsl N + Acc,
    <<Bs:Len/binary, Rest2/binary>> = Rest,
...
'skip_varint_SolverResponse.ModelEntry'(<<1:1, _:7,
					  Rest/binary>>,
					Z1, Z2, F1, F2, TrUserData) ->
    'skip_varint_SolverResponse.ModelEntry'(Rest, Z1, Z2,
					    F1, F2, TrUserData);
'skip_varint_SolverResponse.ModelEntry'(<<0:1, _:7,
					  Rest/binary>>,
					Z1, Z2, F1, F2, TrUserData) ->
    'dfp_read_field_def_SolverResponse.ModelEntry'(Rest, Z1,
						   Z2, F1, F2, TrUserData).


'skip_length_delimited_SolverResponse.ModelEntry'(<<1:1,
						    X:7, Rest/binary>>,
						  N, Acc, F1, F2, TrUserData)
    when N < 57 ->
    'skip_length_delimited_SolverResponse.ModelEntry'(Rest,
						      N + 7, X bsl N + Acc, F1,
						      F2, TrUserData);
'skip_length_delimited_SolverResponse.ModelEntry'(<<0:1,
						    X:7, Rest/binary>>,
						  N, Acc, F1, F2, TrUserData) ->
    Length = X bsl N + Acc,
...
'skip_32_SolverResponse.ModelEntry'(<<_:32,
				      Rest/binary>>,
				    Z1, Z2, F1, F2, TrUserData) ->
    'dfp_read_field_def_SolverResponse.ModelEntry'(Rest, Z1,
						   Z2, F1, F2, TrUserData).
...
'skip_64_SolverResponse.ModelEntry'(<<_:64,
				      Rest/binary>>,
				    Z1, Z2, F1, F2, TrUserData) ->
    'dfp_read_field_def_SolverResponse.ModelEntry'(Rest, Z1,
						   Z2, F1, F2, TrUserData).
...
'd_msg_SolverResponse.Model'(Bin, TrUserData) ->
    'dfp_read_field_def_SolverResponse.Model'(Bin, 0, 0,
					      id([], TrUserData), TrUserData).

'dfp_read_field_def_SolverResponse.Model'(<<10,
					    Rest/binary>>,
					  Z1, Z2, F1, TrUserData) ->
    'd_field_SolverResponse.Model_entries'(Rest, Z1, Z2, F1,
					   TrUserData);
'dfp_read_field_def_SolverResponse.Model'(<<>>, 0, 0,
					  F1, TrUserData) ->
    #'SolverResponse.Model'{entries =
				lists_reverse(F1, TrUserData)};
'dfp_read_field_def_SolverResponse.Model'(Other, Z1, Z2,
					  F1, TrUserData) ->
    'dg_read_field_def_SolverResponse.Model'(Other, Z1, Z2,
					     F1, TrUserData).

'dg_read_field_def_SolverResponse.Model'(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F1, TrUserData)
    when N < 32 - 7 ->
    'dg_read_field_def_SolverResponse.Model'(Rest, N + 7,
					     X bsl N + Acc, F1, TrUserData);
'dg_read_field_def_SolverResponse.Model'(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  'd_field_SolverResponse.Model_entries'(Rest, 0, 0, F1,
						 TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		'skip_varint_SolverResponse.Model'(Rest, 0, 0, F1,
						   TrUserData);
	    1 ->
		'skip_64_SolverResponse.Model'(Rest, 0, 0, F1,
					       TrUserData);
	    2 ->
		'skip_length_delimited_SolverResponse.Model'(Rest, 0, 0,
							     F1, TrUserData);
	    5 ->
		'skip_32_SolverResponse.Model'(Rest, 0, 0, F1,
					       TrUserData)
	  end
    end;
'dg_read_field_def_SolverResponse.Model'(<<>>, 0, 0, F1,
					 TrUserData) ->
    #'SolverResponse.Model'{entries =
				lists_reverse(F1, TrUserData)}.

'd_field_SolverResponse.Model_entries'(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F1, TrUserData)
    when N < 57 ->
    'd_field_SolverResponse.Model_entries'(Rest, N + 7,
					   X bsl N + Acc, F1, TrUserData);
'd_field_SolverResponse.Model_entries'(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, F1, TrUserData) ->
    Len = X bsl N + Acc,
    <<Bs:Len/binary, Rest2/binary>> = Rest,
    NewFValue = id('d_msg_SolverResponse.ModelEntry'(Bs,
						     TrUserData),
		   TrUserData),
    'dfp_read_field_def_SolverResponse.Model'(Rest2, 0, 0,
					      cons(NewFValue, F1, TrUserData),
					      TrUserData).


'skip_varint_SolverResponse.Model'(<<1:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F1, TrUserData) ->
    'skip_varint_SolverResponse.Model'(Rest, Z1, Z2, F1,
				       TrUserData);
'skip_varint_SolverResponse.Model'(<<0:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F1, TrUserData) ->
    'dfp_read_field_def_SolverResponse.Model'(Rest, Z1, Z2,
					      F1, TrUserData).


'skip_length_delimited_SolverResponse.Model'(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, F1, TrUserData)
    when N < 57 ->
    'skip_length_delimited_SolverResponse.Model'(Rest,
						 N + 7, X bsl N + Acc, F1,
						 TrUserData);
'skip_length_delimited_SolverResponse.Model'(<<0:1, X:7,
					       Rest/binary>>,
					     N, Acc, F1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
...
'skip_32_SolverResponse.Model'(<<_:32, Rest/binary>>,
			       Z1, Z2, F1, TrUserData) ->
    'dfp_read_field_def_SolverResponse.Model'(Rest, Z1, Z2,
					      F1, TrUserData).


'skip_64_SolverResponse.Model'(<<_:64, Rest/binary>>,
			       Z1, Z2, F1, TrUserData) ->
    'dfp_read_field_def_SolverResponse.Model'(Rest, Z1, Z2,
					      F1, TrUserData).
...
d_msg_SolverResponse(Bin, TrUserData) ->
    dfp_read_field_def_SolverResponse(Bin, 0, 0,
				      id('MODEL_STATUS', TrUserData),
				      id(undefined, TrUserData), TrUserData).

dfp_read_field_def_SolverResponse(<<8, Rest/binary>>,
				  Z1, Z2, F1, F2, TrUserData) ->
    d_field_SolverResponse_type(Rest, Z1, Z2, F1, F2,
				TrUserData);
dfp_read_field_def_SolverResponse(<<16, Rest/binary>>,
				  Z1, Z2, F1, F2, TrUserData) ->
    d_field_SolverResponse_status(Rest, Z1, Z2, F1, F2,
				  TrUserData);
dfp_read_field_def_SolverResponse(<<26, Rest/binary>>,
				  Z1, Z2, F1, F2, TrUserData) ->
    d_field_SolverResponse_model(Rest, Z1, Z2, F1, F2,
				 TrUserData);
dfp_read_field_def_SolverResponse(<<>>, 0, 0, F1, F2,
				  _) ->
    #'SolverResponse'{type = F1, data = F2};
dfp_read_field_def_SolverResponse(Other, Z1, Z2, F1, F2,
				  TrUserData) ->
    dg_read_field_def_SolverResponse(Other, Z1, Z2, F1, F2,
				     TrUserData).

dg_read_field_def_SolverResponse(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F1, F2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_SolverResponse(Rest, N + 7,
				     X bsl N + Acc, F1, F2, TrUserData);
dg_read_field_def_SolverResponse(<<0:1, X:7,
				   Rest/binary>>,
				 N, Acc, F1, F2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_SolverResponse_type(Rest, 0, 0, F1, F2,
				      TrUserData);
      16 ->
	  d_field_SolverResponse_status(Rest, 0, 0, F1, F2,
					TrUserData);
      26 ->
	  d_field_SolverResponse_model(Rest, 0, 0, F1, F2,
				       TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_SolverResponse(Rest, 0, 0, F1, F2,
					   TrUserData);
	    1 ->
		skip_64_SolverResponse(Rest, 0, 0, F1, F2, TrUserData);
	    2 ->
		skip_length_delimited_SolverResponse(Rest, 0, 0, F1, F2,
						     TrUserData);
	    5 ->
		skip_32_SolverResponse(Rest, 0, 0, F1, F2, TrUserData)
	  end
    end;
dg_read_field_def_SolverResponse(<<>>, 0, 0, F1, F2,
				 _) ->
    #'SolverResponse'{type = F1, data = F2}.

d_field_SolverResponse_type(<<1:1, X:7, Rest/binary>>,
			    N, Acc, F1, F2, TrUserData)
    when N < 57 ->
    d_field_SolverResponse_type(Rest, N + 7, X bsl N + Acc,
				F1, F2, TrUserData);
d_field_SolverResponse_type(<<0:1, X:7, Rest/binary>>,
			    N, Acc, _, F2, TrUserData) ->
    <<Tmp:32/signed-native>> = <<(X bsl N +
				    Acc):32/unsigned-native>>,
    NewFValue = 'd_enum_SolverResponse.Type'(Tmp),
    dfp_read_field_def_SolverResponse(Rest, 0, 0, NewFValue,
				      F2, TrUserData).


d_field_SolverResponse_status(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F1, F2, TrUserData)
    when N < 57 ->
    d_field_SolverResponse_status(Rest, N + 7,
				  X bsl N + Acc, F1, F2, TrUserData);
d_field_SolverResponse_status(<<0:1, X:7, Rest/binary>>,
			      N, Acc, F1, _, TrUserData) ->
    <<Tmp:32/signed-native>> = <<(X bsl N +
				    Acc):32/unsigned-native>>,
    NewFValue = 'd_enum_SolverResponse.Status'(Tmp),
    dfp_read_field_def_SolverResponse(Rest, 0, 0, F1,
				      {status, NewFValue}, TrUserData).


d_field_SolverResponse_model(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F1, F2, TrUserData)
    when N < 57 ->
    d_field_SolverResponse_model(Rest, N + 7, X bsl N + Acc,
				 F1, F2, TrUserData);
d_field_SolverResponse_model(<<0:1, X:7, Rest/binary>>,
			     N, Acc, F1, F2, TrUserData) ->
    Len = X bsl N + Acc,
    <<Bs:Len/binary, Rest2/binary>> = Rest,
    NewFValue = id('d_msg_SolverResponse.Model'(Bs,
						TrUserData),
		   TrUserData),
    dfp_read_field_def_SolverResponse(Rest2, 0, 0, F1,
				      case F2 of
					undefined -> {model, NewFValue};
					{model, MVF2} ->
					    {model,
					     'merge_msg_SolverResponse.Model'(MVF2,
									      NewFValue,
									      TrUserData)};
					_ -> {model, NewFValue}
				      end,
...
skip_varint_SolverResponse(<<1:1, _:7, Rest/binary>>,
			   Z1, Z2, F1, F2, TrUserData) ->
    skip_varint_SolverResponse(Rest, Z1, Z2, F1, F2,
			       TrUserData);
skip_varint_SolverResponse(<<0:1, _:7, Rest/binary>>,
			   Z1, Z2, F1, F2, TrUserData) ->
    dfp_read_field_def_SolverResponse(Rest, Z1, Z2, F1, F2,
				      TrUserData).


skip_length_delimited_SolverResponse(<<1:1, X:7,
				       Rest/binary>>,
				     N, Acc, F1, F2, TrUserData)
    when N < 57 ->
    skip_length_delimited_SolverResponse(Rest, N + 7,
					 X bsl N + Acc, F1, F2, TrUserData);
skip_length_delimited_SolverResponse(<<0:1, X:7,
				       Rest/binary>>,
				     N, Acc, F1, F2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_SolverResponse(Rest2, 0, 0, F1, F2,
				      TrUserData).


skip_32_SolverResponse(<<_:32, Rest/binary>>, Z1, Z2,
		       F1, F2, TrUserData) ->
    dfp_read_field_def_SolverResponse(Rest, Z1, Z2, F1, F2,
				      TrUserData).


skip_64_SolverResponse(<<_:64, Rest/binary>>, Z1, Z2,
		       F1, F2, TrUserData) ->
    dfp_read_field_def_SolverResponse(Rest, Z1, Z2, F1, F2,
				      TrUserData).
...
'd_enum_SolverResponse.Type'(0) -> 'MODEL_STATUS';
'd_enum_SolverResponse.Type'(1) -> 'MODEL_DATA';
'd_enum_SolverResponse.Type'(V) -> V.

'd_enum_SolverResponse.Status'(0) -> 'SAT';
'd_enum_SolverResponse.Status'(1) -> 'UNSAT';
'd_enum_SolverResponse.Status'(2) -> 'UNKNOWN';
'd_enum_SolverResponse.Status'(3) -> 'TIMEOUT';
'd_enum_SolverResponse.Status'(V) -> V.
...
merge_msgs(Prev, New, Opts)
    ...
    case Prev of
      #'SolverResponse.ModelEntry'{} ->
	  'merge_msg_SolverResponse.ModelEntry'(Prev, New,
						TrUserData);
      #'SolverResponse.Model'{} ->
	  'merge_msg_SolverResponse.Model'(Prev, New, TrUserData);
      #'SolverResponse'{} ->
	  merge_msg_SolverResponse(Prev, New, TrUserData);
      #'ErlangTerm.MapEntry'{} ->
...
'merge_msg_SolverResponse.ModelEntry'(#'SolverResponse.ModelEntry'{var
								       = PFvar,
								   value =
								       PFvalue},
				      #'SolverResponse.ModelEntry'{var = NFvar,
								   value =
								       NFvalue},
				      TrUserData) ->
    #'SolverResponse.ModelEntry'{var =
				     if PFvar /= undefined,
					NFvar /= undefined ->
					    merge_msg_ErlangTerm(PFvar, NFvar,
								 TrUserData);
					PFvar == undefined -> NFvar;
					NFvar == undefined -> PFvar
				     end,
				 value =
				     if PFvalue /= undefined,
					NFvalue /= undefined ->
					    merge_msg_ErlangTerm(PFvalue,
								 NFvalue,
								 TrUserData);
...
'merge_msg_SolverResponse.Model'(#'SolverResponse.Model'{entries
							     = PFentries},
				 #'SolverResponse.Model'{entries = NFentries},
				 TrUserData) ->
    #'SolverResponse.Model'{entries =
				'erlang_++'(PFentries, NFentries, TrUserData)}.

merge_msg_SolverResponse(#'SolverResponse'{type =
					       PFtype,
					   data = PFdata},
			 #'SolverResponse'{type = NFtype, data = NFdata},
			 TrUserData) ->
    #'SolverResponse'{type =
			  ...
			  case {PFdata, NFdata} of
			    {{model, OPFdata}, {model, ONFdata}} ->
				{model,
				 'merge_msg_SolverResponse.Model'(OPFdata,
								  ONFdata,
								  TrUserData)};
			    {_, undefined} -> PFdata;
			    _ -> NFdata
...
verify_msg(Msg, Opts) ->
    ...
    case Msg of
      #'SolverResponse.ModelEntry'{} ->
	  'v_msg_SolverResponse.ModelEntry'(Msg,
					    ['SolverResponse.ModelEntry'],
					    TrUserData);
      #'SolverResponse.Model'{} ->
	  'v_msg_SolverResponse.Model'(Msg,
				       ['SolverResponse.Model'], TrUserData);
      #'SolverResponse'{} ->
	  v_msg_SolverResponse(Msg, ['SolverResponse'],
			       TrUserData);
      #'ErlangTerm.MapEntry'{} ->
...
'v_msg_SolverResponse.ModelEntry'(#'SolverResponse.ModelEntry'{var
								   = F1,
							       value = F2},
				  Path, TrUserData) ->
    if F1 == undefined -> ok;
       true -> v_msg_ErlangTerm(F1, [var | Path], TrUserData)
    end,
    if F2 == undefined -> ok;
       true -> v_msg_ErlangTerm(F2, [value | Path], TrUserData)
    end,
    ok;
'v_msg_SolverResponse.ModelEntry'(X, Path,
				  _TrUserData) ->
    mk_type_error({expected_msg,
		   'SolverResponse.ModelEntry'},
		  X, Path).

'v_msg_SolverResponse.Model'(#'SolverResponse.Model'{entries
							 = F1},
			     Path, TrUserData) ->
    if is_list(F1) ->
	   _ = ['v_msg_SolverResponse.ModelEntry'(Elem,
						  [entries | Path], TrUserData)
		|| Elem <- F1],
	   ok;
       true ->
	   mk_type_error({invalid_list_of,
			  {msg, 'SolverResponse.ModelEntry'}},
			 F1, Path)
    end,
    ok;
'v_msg_SolverResponse.Model'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'SolverResponse.Model'}, X,
		  Path).

v_msg_SolverResponse(#'SolverResponse'{type = F1,
				       data = F2},
		     Path, TrUserData) ->
    if F1 == undefined -> ok;
       true -> 'v_enum_SolverResponse.Type'(F1, [type | Path])
    end,
    case F2 of
      undefined -> ok;
      {status, OF2} ->
	  'v_enum_SolverResponse.Status'(OF2,
					 [status, data | Path]);
      {model, OF2} ->
	  'v_msg_SolverResponse.Model'(OF2, [model, data | Path],
				       TrUserData);
      _ -> mk_type_error(invalid_oneof, F2, [data | Path])
    end,
    ok.
...
'v_enum_SolverResponse.Type'('MODEL_STATUS', _Path) ->
    ok;
'v_enum_SolverResponse.Type'('MODEL_DATA', _Path) -> ok;
'v_enum_SolverResponse.Type'(V, Path)
    when is_integer(V) ->
    v_type_sint32(V, Path);
'v_enum_SolverResponse.Type'(X, Path) ->
    mk_type_error({invalid_enum, 'SolverResponse.Type'}, X,
		  Path).

'v_enum_SolverResponse.Status'('SAT', _Path) -> ok;
'v_enum_SolverResponse.Status'('UNSAT', _Path) -> ok;
'v_enum_SolverResponse.Status'('UNKNOWN', _Path) -> ok;
'v_enum_SolverResponse.Status'('TIMEOUT', _Path) -> ok;
'v_enum_SolverResponse.Status'(V, Path)
    when is_integer(V) ->
    v_type_sint32(V, Path);
'v_enum_SolverResponse.Status'(X, Path) ->
    mk_type_error({invalid_enum, 'SolverResponse.Status'},
		  X, Path).
...
get_msg_defs() ->
    [{{enum, 'SolverResponse.Type'},
      [{'MODEL_STATUS', 0}, {'MODEL_DATA', 1}]},
     {{enum, 'SolverResponse.Status'},
      [{'SAT', 0}, {'UNSAT', 1}, {'UNKNOWN', 2},
       {'TIMEOUT', 3}]},
     {{enum, 'ErlangTerm.Type'},
      [{'INTEGER', 0}, {'FLOAT', 1}, {'ATOM', 2},
       ...
       {'SUBTERM', 12}, {'ANY', 13}]},
     {{msg, 'SolverResponse.ModelEntry'},
      [#field{name = var, fnum = 1, rnum = 2,
	      type = {msg, 'ErlangTerm'}, occurrence = optional,
	      opts = []},
       #field{name = value, fnum = 2, rnum = 3,
	      type = {msg, 'ErlangTerm'}, occurrence = optional,
	      opts = []}]},
     {{msg, 'SolverResponse.Model'},
      [#field{name = entries, fnum = 1, rnum = 2,
	      type = {msg, 'SolverResponse.ModelEntry'},
	      occurrence = repeated, opts = []}]},
     {{msg, 'SolverResponse'},
      [#field{name = type, fnum = 1, rnum = 2,
	      type = {enum, 'SolverResponse.Type'},
	      occurrence = optional, opts = []},
       #gpb_oneof{name = data, rnum = 3,
		  fields =
		      [#field{name = status, fnum = 2, rnum = 3,
			      type = {enum, 'SolverResponse.Status'},
			      occurrence = optional, opts = []},
		       #field{name = model, fnum = 3, rnum = 3,
			      type = {msg, 'SolverResponse.Model'},
			      occurrence = optional, opts = []}]}]},
     {{msg, 'ErlangTerm.MapEntry'},
...
get_msg_names() ->
    ['SolverResponse.ModelEntry', 'SolverResponse.Model',
     'SolverResponse', 'ErlangTerm.MapEntry',
     'ErlangTerm.FunEntry', 'ErlangTerm'].


get_enum_names() ->
    ['SolverResponse.Type', 'SolverResponse.Status',
     'ErlangTerm.Type'].
...
find_msg_def('SolverResponse.ModelEntry') ->
    [#field{name = var, fnum = 1, rnum = 2,
	    type = {msg, 'ErlangTerm'}, occurrence = optional,
	    opts = []},
     #field{name = value, fnum = 2, rnum = 3,
	    type = {msg, 'ErlangTerm'}, occurrence = optional,
	    opts = []}];
find_msg_def('SolverResponse.Model') ->
    [#field{name = entries, fnum = 1, rnum = 2,
	    type = {msg, 'SolverResponse.ModelEntry'},
	    occurrence = repeated, opts = []}];
find_msg_def('SolverResponse') ->
    [#field{name = type, fnum = 1, rnum = 2,
	    type = {enum, 'SolverResponse.Type'},
	    occurrence = optional, opts = []},
     #gpb_oneof{name = data, rnum = 3,
...
find_enum_def('SolverResponse.Type') ->
    [{'MODEL_STATUS', 0}, {'MODEL_DATA', 1}];
find_enum_def('SolverResponse.Status') ->
    [{'SAT', 0}, {'UNSAT', 1}, {'UNKNOWN', 2},
     {'TIMEOUT', 3}];
...
enum_symbol_by_value('SolverResponse.Type', Value) ->
    'enum_symbol_by_value_SolverResponse.Type'(Value);
enum_symbol_by_value('SolverResponse.Status', Value) ->
    'enum_symbol_by_value_SolverResponse.Status'(Value);
enum_symbol_by_value('ErlangTerm.Type', Value) ->
    'enum_symbol_by_value_ErlangTerm.Type'(Value).


enum_value_by_symbol('SolverResponse.Type', Sym) ->
    'enum_value_by_symbol_SolverResponse.Type'(Sym);
enum_value_by_symbol('SolverResponse.Status', Sym) ->
    'enum_value_by_symbol_SolverResponse.Status'(Sym);
enum_value_by_symbol('ErlangTerm.Type', Sym) ->
    'enum_value_by_symbol_ErlangTerm.Type'(Sym).


'enum_symbol_by_value_SolverResponse.Type'(0) ->
    'MODEL_STATUS';
'enum_symbol_by_value_SolverResponse.Type'(1) ->
    'MODEL_DATA'.


'enum_value_by_symbol_SolverResponse.Type'('MODEL_STATUS') ->
    0;
'enum_value_by_symbol_SolverResponse.Type'('MODEL_DATA') ->
    1.

'enum_symbol_by_value_SolverResponse.Status'(0) ->
    'SAT';
'enum_symbol_by_value_SolverResponse.Status'(1) ->
    'UNSAT';
'enum_symbol_by_value_SolverResponse.Status'(2) ->
    'UNKNOWN';
'enum_symbol_by_value_SolverResponse.Status'(3) ->
    'TIMEOUT'.


'enum_value_by_symbol_SolverResponse.Status'('SAT') ->
    0;
'enum_value_by_symbol_SolverResponse.Status'('UNSAT') ->
    1;
'enum_value_by_symbol_SolverResponse.Status'('UNKNOWN') ->
    2;
'enum_value_by_symbol_SolverResponse.Status'('TIMEOUT') ->
    3.
