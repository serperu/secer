...
get_msg_names() ->
    ['Spec.TypeDef', 'Spec.RangeBounds', 'Spec.SegmentSize',
     'Spec.FunSig', 'Spec.FunDet', 'Spec.Type',
     'Spec.TypeList', 'Spec', 'ErlangTerm.MapEntry',
     'ErlangTerm.FunEntry', 'ErlangTerm'].


get_enum_names() -> ['Spec.ErlType', 'ErlangTerm.Type'].
